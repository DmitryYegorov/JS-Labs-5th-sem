 ...
 */
{
 ...
 let a = 45;
 let b = 21;
 console.log(`Площадь четырёхугольнгика a = ${a}, b = ${b} равна ${rectangleArea(a,b)} mm`);
}
...

{
    ...
    console.log(`В четырёхугольник поместиться ${i} квадратов`);
}
 ...
 */
  ...
  */
  ...
  {
      let secretAnswer = prompt("Девичья фамилия вашей матери: ", '');
      if (secretAnswer === "Королёва"){
          alert(true);
      }else{
          alert(false);
      }
   ...
   */
    ...
    */
    ...
    {
        let russianIsCompleted = confirm('Русский');
        let mathIsCompleted = confirm('Математика');
        let englishIsCompleted = confirm('Англиский');
